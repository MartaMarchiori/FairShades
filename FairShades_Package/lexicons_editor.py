...
protected = { #'sexual': editor.template('{sexual_adj}').data,
    ...
    'male': list(map(lambda x: x.lower(), editor.template('{male}').data[:10])),#editor.template('{male}').data,
    'female': list(map(lambda x: x.lower(), editor.template('{female}').data[:10])),#editor.template('{female}').data,
